...
from fast_deploy.backends.ort import convert_pytorch, create_model_for_provider, bert_optimize_onnx
from fast_deploy.backends.trt import (
    build_engine,
    get_binding_idxs,
    infer_tensorrt,
    load_engine,
...
def main():
    ...
    convert_pytorch(model_pytorch=model_pytorch, output_path=onnx_model_path, inputs_pytorch=inputs_pytorch)
