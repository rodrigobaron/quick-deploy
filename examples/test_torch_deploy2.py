...
from src.fast_deploy.backend.torch_ort import (
    convert_pytorch,
...
from src.fast_deploy.utils import LMPerformanceBenchmark, OnnxPerformanceBenchmark
...
if __name__ == '__main__':
    ...
    generic_optimize_onnx(onnx_path=onnx_optim_fp16_path, output_path=onnx_optim_fp16_path)
